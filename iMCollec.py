...
ap.add_argument("-p", "--path", required=True, type=str, help="Path to the directory where images are saved")
...
ap.add_argument("-f", "--format", default="jpg", type=str, help="Format of the images, Must be wether jpg or png")
...
collector = Collect(args["path"], args["name"], args["classes"],
					 args["steps"], args["space"], args["resolution"], args["format"])
